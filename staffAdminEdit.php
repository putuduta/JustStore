...
<body>
    ...
    <div class="mx-auto mt-lg-3 mb-lg-5 shadow p-3 mb-5 bg-white rounded" style="width: 800px;">
        ...
        <div class="card-body">
            <form id="editStaffAdmin" name="editStaffAdmin" method="POST" action="staffAdminEditAction.php?id=<?php echo $data['id']; ?>" enctype="multipart/form-data">
